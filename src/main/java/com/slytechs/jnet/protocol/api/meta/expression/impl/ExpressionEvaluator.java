...
/**
 * Evaluates compiled expressions with comprehensive debugging support. This
 * class adds debug hooks and event tracking while maintaining performance when
...
public final class ExpressionEvaluator {
	...
	/**
	 * Gets the current evaluation arguments. Package private, used by ArgumentNode.
	 */
	 ...
	 */
	public ExprValue run(Object... args) {
		try {
			...
			ExprValue result = root.evaluate(this::resolveVariableInternal);
