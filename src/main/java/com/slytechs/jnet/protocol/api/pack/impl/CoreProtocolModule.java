 ...
 */
public class CoreProtocolModule implements ProtocolModule {
	...
	public CoreProtocolModule() {
		this(NAME, ProtocolPackTable.CORE, new Version(VERSION));
	}

	private CoreProtocolModule(String name, PackId packId, Version version) {
