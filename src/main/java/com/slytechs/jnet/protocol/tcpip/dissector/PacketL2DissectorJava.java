...
import static com.slytechs.jnet.protocol.tcpip.arp.ArpConstants.*;
import static com.slytechs.jnet.protocol.tcpip.ethernet.EtherConstants.*;
import static com.slytechs.jnet.protocol.tcpip.ethernet.EtherType.*;
import static com.slytechs.jnet.protocol.tcpip.ethernet.VlanConstants.*;
import static com.slytechs.jnet.protocol.tcpip.ipx.IpxConstants.*;
import static com.slytechs.jnet.protocol.tcpip.mpls.MplsConstants.*;
import static com.slytechs.jnet.protocol.tcpip.stp.StpConstants.*;
...
public abstract class PacketL2DissectorJava extends AbstractPacketDissector {
	...
	protected final void dissectEthernet(int offset) {
		...
		if (type > ETHER_MIN_VALUE_FOR_TYPE) {
			...
			if ((control == LLC_TYPE_FRAME)
					&& (ssap == LLC_TYPE_SNAP)
					&& (dsap == LLC_TYPE_SNAP)
					&& hasRemaining(offset, SNAP_HEADER_LEN)) { // Snap + FrameHeader = SNAP
	 ...
	 * @return the int
	 * @see com.slytechs.jnet.protocol.api.descriptor.impl.PacketDissector#dissectPacket(java.nio.ByteBuffer,
	 *      long, int, int)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.protocol.api.descriptor.impl.PacketDissector#isNative()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.protocol.api.descriptor.impl.PacketDissector#setDatalinkType(com.slytechs.jnet.protocol.api.core.L2FrameType)
	 */
	@Override
