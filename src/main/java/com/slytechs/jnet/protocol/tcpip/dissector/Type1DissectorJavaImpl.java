...
public class Type1DissectorJavaImpl extends PacketL3DissectorJava {
	 ...
	 * @param desc the desc
	 * @return the int
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#writeDescriptor(java.nio.ByteBuffer)
	 */
	@Override
	 ...
	 * @param hlen       the hlen
	 * @param nextHeader the next header
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectIp4Options(int,
	 *      int, int)
	 */
	@Override
	 ...
	 * @param offset     the offset
	 * @param nextHeader the next header
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectIp6Options(int,
	 *      int)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#addRecord(int,
	 *      int, int)
	 */
	@Override
	 ...
	 *
	 * @param offset the offset
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectUdp(int)
	 */
	@Override
	 ...
	 *
	 * @param offset the offset
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectGre(int)
	 */
	@Override
	 ...
	 *
	 * @param offset the offset
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectIcmp6(int)
	 */
	@Override
	 ...
	 *
	 * @param offset the offset
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectIcmp4(int)
	 */
	@Override
	 ...
	 *
	 * @param offset the offset
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectSctp(int)
	 */
	@Override
	 ...
	 * @param src    the src
	 * @param dst    the dst
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectExtensionPorts(java.nio.ByteBuffer,
	 *      int, int, int, int)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnet.protocol.tcpip.dissector.PacketL3DissectorJava#dissectTcpOptions(int,
	 *      int)
	 */
	@Override
