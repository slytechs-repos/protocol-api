...
public class IpReassemblyEvent {
	...
	private final IpfEventType type;
	private final IpfFragmentDescriptor fragment;
	 ...
	 */
	public IpReassemblyEvent(IpfEventType type, IpfFragmentDescriptor fragment) {
	...
	public IpReassemblyEvent(
			IpfEventType type,
			IpfFragmentDescriptor fragment,
			long timestamp,
			int fragmentSize,
			int totalSize,
			int fragmentCount,
	 ...
	 */
	public IpfFragmentDescriptor getFragment() {
		return fragment;
	}
