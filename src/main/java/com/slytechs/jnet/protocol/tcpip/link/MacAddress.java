...
import com.slytechs.jnet.protocol.api.common.NetAddress;
import com.slytechs.jnet.protocol.api.common.NetAddressType;
import com.slytechs.jnet.protocol.tcpip.constants.MacOuiAssignments;
import com.slytechs.jnet.protocol.tcpip.constants.MacOuiAssignments.OuiEntry;
...
public class MacAddress implements NetAddress {
	 ...
	 *
	 * @return the byte[]
	 * @see com.slytechs.jnet.protocol.api.common.NetAddress#toArray()
	 */
	@Override
	public byte[] toArray() {
		return src;
	 ...
	 * @see com.slytechs.jnet.protocol.api.common.NetAddress#type()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.protocol.api.common.NetAddress#byteSize()
	 */
	@Override
	public int byteSize() {
