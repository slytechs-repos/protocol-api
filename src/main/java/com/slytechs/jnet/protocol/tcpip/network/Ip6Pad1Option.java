 ...
 * </p>
 */
@MetaResource("ip6-opt-pad1-meta.json")
public final class Ip6Pad1Option extends Ip6Option {

	public static final int ID = Ip6IdOption.IPv6_ID_OPT_PAD1;

	/**
	 * Instantiates a new IPv6 jumbo payload hop-by-hop option.
	 */
	public Ip6Pad1Option() {
		super(ID);
	}
