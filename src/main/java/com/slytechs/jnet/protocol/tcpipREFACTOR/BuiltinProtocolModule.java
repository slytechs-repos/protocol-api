 ...
 */
public class BuiltinProtocolModule implements ProtocolModule {
	...
	public BuiltinProtocolModule() {
		this(NAME, ProtocolPackTable.CORE, new Version(VERSION));
	}

	private BuiltinProtocolModule(String name, PackId packId, Version version) {
