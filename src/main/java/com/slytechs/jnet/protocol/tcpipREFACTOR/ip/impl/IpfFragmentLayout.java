 ...
 * the License.
 */
package com.slytechs.jnet.protocol.tcpipREFACTOR.ip.impl;
 ...
 */
public enum IpfFragmentLayout implements BitField.Proxy {
		...
		private static final BinaryLayout STRUCT = structLayout(
				...
				unionLayout(
						structLayout(
								...
								unionLayout(
										structLayout(
												sequenceLayout(IpAddress.IPv4_ADDRESS_SIZE, Int8.BITS_08).withName(
														"ip4_src"),
												sequenceLayout(IpAddress.IPv4_ADDRESS_SIZE, Int8.BITS_08).withName(
														"ip4_dst")),
										structLayout(
												sequenceLayout(IpAddress.IPv6_ADDRESS_SIZE, Int8.BITS_08).withName(
														"ip6_src"),
												sequenceLayout(IpAddress.IPv6_ADDRESS_SIZE, Int8.BITS_08).withName(
														"ip6_dst"))
