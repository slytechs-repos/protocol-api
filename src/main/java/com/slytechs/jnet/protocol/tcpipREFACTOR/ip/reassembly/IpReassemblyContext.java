...
class IpReassemblyContext {
	...
	private IpfFragmentDescriptor descriptor;
	 ...
	 */
	void initialize(IpfFragmentDescriptor descriptor, long timestamp) {
	 ...
	 */
	void updateState(IpfFragmentDescriptor fragment, long timestamp) {
		setLastUpdateTime(timestamp);
	 ...
	 */
	void copyFragmentFromSegment(MemorySegment segment, IpfFragmentDescriptor fragment) {
		int fragOffset = fragment.fragOffset();
	 ...
	 */
	void copyFragmentFromBuffer(ByteBuffer buffer, IpfFragmentDescriptor fragment) {
		int fragOffset = fragment.fragOffset();
		int dataOffset = fragment.dataOffset();
		int dataLength = fragment.dataLength();
	 ...
	 */
	boolean hasFragment(IpfFragmentDescriptor fragment) {
	...
	IpfFragmentDescriptor getDescriptor() {
		return descriptor;
	}
